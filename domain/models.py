...
class WorkWindow(Base):
    ...
    especialist_code: Mapped[str] = mapped_column(
        String(20), ForeignKey("especialist.code"), nullable=False,
    )
    application_code: Mapped[str] = mapped_column(
        String(50), ForeignKey("applications.code"), nullable=False,
    )
...
class SpecialistFolder(Base):
    __tablename__ = "specialist_folders"
    __table_args__ = (
        UniqueConstraint("application_code", "especialist_code", name="uq_app_specialist"),
    )
